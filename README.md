...
- **SoLei-Punktestand als eigene Seite** – die Punktestand-Liste des aktuellen Quartals (Punktesumme, Note, Bearbeitungsstand je Schüler/in) ist zusätzlich zur Kursseite über einen eigenen Menüpunkt erreichbar; ein Tipp auf eine Person öffnet ihr Punkteprotokoll.
...
- **Übersichtliches Kurs-Menü** – die Kursseite ordnet alle Funktionen paarweise an: SoLei-Punkte vergeben / Sitzplan, SoLei-Punktestand / Ergebnis-Uploads, Unentschuldigte Fehlzeiten / SoLei-Quartalsnoten, Open Book Tests / Klausuren, Notenübersicht & Zeugnisnoten / Kurs-Einstellungen. Die Titelzeile aller Einzelseiten führt einheitlich zu den Einstellungen und zur Startseite.
