...
(function (root, factory) {
  ...
  var GLOSSARY = [
    ...
    { term: 'Sitzplan', def: 'Raster mit den Plätzen einer Klasse, wahlweise mit Fotos. Dient dem schnellen Wiedererkennen und dem Vergeben von SL-Punkten direkt am Platz. Je Kurs sind mehrere Sitzpläne möglich (meist je Raum); Klassensprecher/in und Stellvertretung erscheinen darin als Abzeichen K1 und K2.' },
      ...
      chapters: [
        ...
        },
        {
          ...
          body: [
            ...
            { t: 'p', v: 'Die Installation ist jederzeit nachholbar: [[app:settings|Globale Einstellungen]], Abschnitt „App-Installation“. Nach der Installation bleibt das Browser-Fenster geöffnet – **schließen Sie es und arbeiten Sie ab dann im App-Symbol**. Solange Sie im Browser weiterarbeiten, weist die App oben darauf hin. Solange die App nicht installiert ist, erinnert der Startbildschirm alle drei Tage daran – bewusst häufiger als die etwa sieben Tage, nach denen Safari die Daten nicht installierter Websites löscht. Sobald die App installiert ist, erscheint die Erinnerung nicht mehr.' },
        ...
        },
        {
          ...
          body: [
            ...
            { t: 'p', v: '**PIN oder Passwort?** Die PIN (6 bis 8 Ziffern) schützt vor neugierigen Blicken im Alltag: Am Gerät bremst die App nach fünf Fehlversuchen, und so bleibt Raten aussichtslos. Gegen eine **kopierte Datei** bremst niemand – wer den Browserspeicher eines gestohlenen Geräts in der Hand hat, kann alle Ziffernkombinationen offline durchprobieren, und das dauert bei sechs Ziffern Stunden, nicht Jahre. Das App-Passwort (mindestens 10 Zeichen) hält auch dem stand. Wer das Gerät regelmäßig mitnimmt oder Schülerdaten mehrerer Klassen führt, wählt deshalb das Passwort.' }
          ]
        },
        {
          id: 'start-schueler',
      ...
      chapters: [
        ...
        },
        {
          ...
          body: [
            ...
            { t: 'warn', v: 'Wichtig für **automatische Ordner-Backups**: Seit Version 0.54 sind diese Dateien **ausschließlich mit dem** {{Wiederherstellungsschlüssel}} verschlossen – PIN und App-Passwort öffnen sie nicht. Das ist Absicht: Eine kopierte Datei ließe sich sonst durch Raten der PIN öffnen. Zum Einspielen auf einem neuen Gerät brauchen Sie also den 24-stelligen Schlüssel. Ohne Schlüssel schreibt die App nur dann ein automatisches Backup, wenn Sie das App-Passwort nutzen; mit PIN und ohne Schlüssel schreibt sie **keines** und sagt das in den Einstellungen unter „Datensicherung“. Ältere Dateien (bis Version 0.53) tragen noch den PIN- bzw. Passwort-Umschlag vom Tag der Sicherung und öffnen sich weiterhin mit der damaligen Eingabe oder dem Schlüssel; löschen Sie sie, sobald eine neue Datei geschrieben wurde.' },
            { t: 'note', v: 'Beim Einspielen prüft die App die Datei auf unbrauchbare Einträge – etwa Punktevergaben ohne gültiges Datumsformat. Findet sie welche, nennt sie die Anzahl **vor** der Bestätigung; alles Übrige wird unverändert übernommen. Geprüft wird ausschließlich die Schreibweise: Ein Eintrag an einem Tag, der laut Kurs-Einstellungen kein Unterrichtstag ist – eine Vertretungsstunde etwa –, ist völlig in Ordnung und bleibt erhalten.' },
        ...
        },
        {
          ...
          body: [
            ...
            { t: 'p', v: '**Klassensprecher/in:** Auf „Schülerliste bearbeiten“ legen Sie oben über zwei Auswahlfelder fest, wer Klassensprecher/in (**K1**) und wer Stellvertretung (**K2**) ist. Die Rolle gehört zur Klasse, nicht zum Fach – sie erscheint deshalb in allen Ihren Kursen dieser Klasse, in der Schülerliste und als Abzeichen am Foto im {{Sitzplan}}. Im Partnerkurs ist sie nicht änderbar, weil die Schülerliste dort von der notengebenden Lehrkraft stammt.' },
            { t: 'note', v: 'Fotos lassen sich auch **klassenweise** sichern – praktisch, um einer Kollegin die Fotos genau einer Klasse zu geben, statt den gesamten Bestand zu verschicken. Die Auswahl steht im Dialog „Fotos jetzt sichern“; bei genau einer Klasse trägt die Datei deren Namen. Beim Einspielen übernimmt die App nur Fotos, deren Person auf dem Gerät in einer Klasse steht, und nennt die verworfenen. Damit das funktioniert, muss die Empfängerin die Klasse über den Kurs-Import erhalten haben – bei selbst angelegten Klassen sind die Schülerkennungen andere, und kein Foto findet seine Person.' },
            { t: 'note', v: 'Die Auto-Backup-Datei ist mit dem {{Wiederherstellungsschlüssel}} verschlossen, nicht mit der PIN. Nutzen Sie eine PIN und haben noch keinen Schlüssel, schreibt die App kein automatisches Backup – die Einstellungen zeigen das mit einem Hinweis und dem Knopf „Wiederherstellungsschlüssel anlegen“.' }
          ]
        },
        {
          id: 'faq-sitzplan-drucken',
          group: 'Gerät & Technik',
          title: 'Kann ich den Sitzplan ausdrucken?',
          body: [
            { t: 'p', v: 'Ja. Öffnen Sie den {{Sitzplan}}, wechseln Sie auf „bearbeiten/drucken“ und tippen Sie in der Leiste über dem Raster auf **Drucken**. Der Ausdruck enthält Fotos, Vor- und Nachnamen, die Abzeichen **K1** und **K2**, den Balken „Lehrerpult“ zur Orientierung und – falls vorhanden – eine Zeile mit noch nicht platzierten Personen.' },
            { t: 'p', v: 'Der Plan passt immer auf **eine** Seite im Querformat: Die Kachelgröße wird aus der Zahl der Spalten und Reihen berechnet. Bei sehr großen Rastern werden die Kacheln kleiner, und wenn selbst dafür der Platz nicht reicht, entfallen die Fotos zugunsten der Namen.' },
            { t: 'warn', v: 'Ein ausgedruckter Sitzplan enthält Fotos und Namen – also besonders schützenswerte Daten. Behandeln Sie das Blatt entsprechend und entsorgen Sie es nicht im offenen Papierkorb.' },
            { t: 'note', v: 'Auf dem iPad und in installierten Apps öffnet sich der Druck in einem eigenen Fenster. Wird es blockiert, erlauben Sie für SOL-Noten Pop-up-Fenster und tippen erneut.' }
          ]
        },
        {
          ...
          body: [
            ...
            { t: 'p', v: 'Unterrichten Sie dieselbe Klasse zusätzlich in einem **eigenen** Fach, in dem Sie selbst die Note vergeben, legen Sie den Kurs über „Neuer Kurs für ein anderes Fach in dieser Klasse“ in den Einstellungen des Partnerkurses an. Die Schülerliste wird übernommen, Abtippen entfällt, und der Partnerkurs bleibt unberührt. Bewertungsstruktur und Maximalpunkte beginnen dabei bei den Voreinstellungen, weil der Partnerkurs die der anderen Lehrkraft trägt.' },
      ...
      chapters: [
        ...
        },
        {
          ...
          body: [
            ...
            { t: 'p', v: 'Verwendet wird das Verfahren AES-256-GCM – derselbe Standard, den Banken und Behörden einsetzen. Das Passwort selbst wird nicht gespeichert; aus ihm wird der Schlüssel jedes Mal neu berechnet, und zwar absichtlich langsam (310.000 Rechenrunden), damit systematisches Durchprobieren eines Passworts aussichtslos wird. Bei einer PIN gilt das nur mit Einschränkung: Sie hat wenige Kombinationen, und eine kopierte Datei bremst niemand – deshalb sind automatische Ordner-Backups mit dem {{Wiederherstellungsschlüssel}} statt mit der PIN geschützt, und deshalb empfiehlt die App bei mobil genutzten Geräten das Passwort.' },
