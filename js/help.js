      ...
      chapters: [
        ...
        },
        {
          ...
          body: [
            ...
            { t: 'warn', v: 'Wichtig für **automatische Ordner-Backups**: Jede dieser Dateien ist mit der PIN bzw. dem Passwort verschlossen, die **am Tag der Sicherung** galten. Ändern Sie PIN oder Passwort, öffnen ältere Dateien weiterhin nur mit der früheren Eingabe – die aktuelle wird abgewiesen. Notieren Sie deshalb bei einem Wechsel, ab wann die neue gilt, oder erstellen Sie danach ein manuelles {{Backup}} mit eigenem Passwort. Ab Version 0.45 führen neue Ordner-Backups zusätzlich den {{Wiederherstellungsschlüssel}} mit; er öffnet sie unabhängig von PIN-Wechseln.' },
